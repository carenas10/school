...
/*
$ mpirun -np 3 ./basic 0 10 30
Process 0 uses 0.000004s to calculate partial result 12.407407
Process 2 uses 0.000004s to calculate partial result 234.629630
Process 1 uses 0.000004s to calculate partial result 86.481481
Calculating the integral of f(x) from 0.000000 to 10.000000
The integral is 333.518519
Communication time: 0.00055s
*/
