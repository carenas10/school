/*
OUTPUT:
$ mpirun -np 3 ./cyclic 0 10 30
Process 0 uses 0.000004s to calculate partial result 100.185187
Process 1 uses 0.000004s to calculate partial result 110.925928
Process 2 uses 0.000004s to calculate partial result 122.407409
Calculating the integral of f(x) from 0.000000 to 10.000000
The integral is 333.518524
Communication time: 0.00575s
*/
